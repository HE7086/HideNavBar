...
sleep 1
cmd overlay fabricate --target android --name test2 android:dimen/navigation_bar_height 0x05 0x0
cmd overlay enable com.android.shell:test2
cmd overlay fabricate --target android --name test android:dimen/navigation_bar_frame_height 0x05 0x4000
cmd overlay enable com.android.shell:test
cmd overlay fabricate --target android --name test3 android:dimen/navigation_bar_gesture_height 0x05 0x4000
